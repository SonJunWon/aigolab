...
const NOTICES: Notice[] = [
  ...
  {
    id: "n010",
    title: "🏆 AI 에이전트 엔지니어링 3부작 완결 — 고급1·2·3 총 72강",
    content: "AI 에이전트를 만들고, 조직하고, 기르는 전체 여정 — 3부작 72강이 모두 완성되었습니다.\n\n• 고급1 하네스 엔지니어링 (24강): 에이전트 = 모델(뇌) + 하네스(몸). 루프·도구·컨텍스트·기억·가드레일 5대 기관을 해부하고, 미니 Claude Code를 직접 구현합니다.\n• 고급2 멀티에이전트 시스템 (24강): 멀티에이전트 = 조직 설계. 분업·역할·지휘·전달·신뢰 5대 축으로 팀을 짓고, 실전 아크에서 '자동 코드리뷰 회사'를 완성합니다.\n• 고급3 평가·운영 (24강): 출시는 관측의 시작. 운영 루프 5국면(관측·평가·진단·개선·통제)으로 시스템을 기르고, '운영 30일' 시뮬레이션을 완주합니다.\n\n각 트랙의 시리즈 A(이야기, 코드 0줄)는 전면 무료입니다 — 비개발자도 지금 바로 시작할 수 있어요. 시리즈 B(다루기)·C(만들기)는 PRO로 제공됩니다.\n\n'AI 앱 개발 → AI 엔지니어링 트랙'에서 고급1부터 순서대로 만나보세요. 입문 → 중급1 → MCP → 중급2 → 고급1 → 고급2 → 고급3으로 이어지는 전체 로드맵이 완성되었습니다.",
    category: "update",
    pinned: true,
    date: "2026-07-11",
  },
