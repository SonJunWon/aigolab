...
export const COURSE_GROUPS: CourseGroup[] = [
  ...
  },
  {
    ...
    courseIds: [
      ...
      "kd-17-qlora",
      "kd-18-trl-unsloth",
      "kd-19-lora-hyperparams",
      "kd-20-lora-plus",
      "kd-21-dora",
      "kd-22-adalora",
      "kd-23-data-synthesis",
      "kd-24-adapter-merge",
      "kd-25-data-quality-lima",
      "kd-26-data-collection",
      "kd-27-llm-generation-gate",
      "kd-28-cleaning-basic",
      "kd-29-cleaning-safety",
      "kd-30-pipeline",
      "kd-31-trl-sft-capstone",
      "kd-32-instruction-tuning",
      "kd-33-continuous-learning",
      "kd-34-llm-as-judge",
    ],
