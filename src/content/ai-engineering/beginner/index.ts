...
// ── 01~05: 일반 사용자 친화 버전으로 대체 ──────────────────────────────
// 기존 코드 중심 강의(01-webllm-intro.ts … 05-tool-calling.ts)는 파일로 그대로
...
// ── 06~12: 기존 코드 강의 유지 (아직 친화 버전 미제작) ─────────────────
 ...
 * 01~05 는 친화 버전, 06~12 는 기존 코드 강의(친화 재구성 예정).
