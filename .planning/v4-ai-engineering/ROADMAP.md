...
**작성일**: 2026-04-15 (버전 매핑 2026-04-16 개정)
**상태**: 🟢 Phase 1 완료 (v4.0~v4.2 출시) · Phase 2 PLAN 작성됨
**목표 버전**: v4.0.0 ~ v4.6.0 (순차 릴리즈 — 초안 대비 +2 slot shift)
...
- 신규 컴포넌트: Thought Stream 셀, JSON Schema 비주얼 에디터 (선택)
- SDK 확장: `responseSchema`, `stream`/`onToken`, `tools`/`chatWithTools`
- 성공 지표: 학생이 CoT 로 reasoning 문제 풀고 자기 tool 로 에이전트 기초 체험
- PLAN: [v4.3/PLAN.md](./v4.3/PLAN.md)

### Phase 3 · **v4.4.0** (~2 주)
**에이전트 축**: Ch06 단일 에이전트, Ch07 멀티 에이전트
- 신규 컴포넌트: Agent Trace Viewer, Swimlane 다이어그램
- 16·17번째 AI 프로젝트: "이메일 에이전트", "조사·집필·검토 삼각팀"
